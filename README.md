...
- **完整工程化** —— **140 个测试套件 / 1173 个用例**（jest，带「只许上调」的覆盖率门槛，2026-09-17 实测）、Playwright 可视化回归（100 条：golden-image + 脏矩形像素一致性 + 视口/对齐/交互 + 92 个示例页冒烟）、发布包完整性门禁（`publint` + `attw`）、eslint、架构设计文档。
